...
const styles = StyleSheet.create({
  ...
  eyebrow: { marginBottom: 8, marginTop: 4 },
  card: { paddingHorizontal: 16, paddingVertical: 4, marginBottom: 20 },
  section: { marginTop: 16 },
  heading: { ...font('extrabold', 14, { color: palette.ink }), marginBottom: 4 },
  para: { ...text.body, color: palette.grey600, lineHeight: 21, marginBottom: 4 },
  updated: { ...text.caption, color: palette.grey450, marginTop: 16, marginBottom: 8 },
});
